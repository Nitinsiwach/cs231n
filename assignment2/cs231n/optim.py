...
def adam(x, dx, config=None):
    ...
    config['t'] += 1
    unbiased_first = config['m']/(1 - config['beta1']**config['t'])
    unbiased_second = config['v']/(1 - config['beta2']**config['t'])
    
    next_x = x - config['learning_rate']*unbiased_first/(np.sqrt(unbiased_second) + config['epsilon'])
    ###########################################################################
    #                             END OF YOUR CODE                            #
    ###########################################################################
